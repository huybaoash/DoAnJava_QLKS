...
import sample.QLKS_ClassData.HoaDon;
import sample.QLKS_ClassData.PhieuDV;
import sample.QLKS_ClassData.PhieuDatPhong;
...
public class HoaDonDetails {
    ...
    void PressInHD(ActionEvent event) {
        // hên xui, làm dc thì ép vào // xuất hóa đơn như bán hàng đc ko
        // nó đó, nhưng mà đang kiếm sao thằng bẹn nhân nó kêu tìm ra mà có thấy gì đâu?
    }
